---
# tidals-scripts-94rh
title: Add Debug Tab to TidalsGoldSuperheater
status: completed
type: task
priority: normal
...
Add verbose logging and a Debug UI tab to TidalsGoldSuperheater.
...
- [ ] Build and verify with `osmb build TidalsGoldSuperheater`